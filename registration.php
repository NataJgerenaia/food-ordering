...
if(isset($_POST['submit'])) {
    ...
    // Check for empty fields (not shown for brevity)
    ...
    if($_POST['password'] != $_POST['cpassword']) {
        ...
        $stmt = $db->prepare($mql);
        $stmt->bind_param("sssssss", $_POST['username'], $_POST['firstname'], $_POST['lastname'], $_POST['email'], $_POST['phone'], password_hash($_POST['password'], PASSWORD_DEFAULT), $_POST['address']);
        $stmt->execute();
